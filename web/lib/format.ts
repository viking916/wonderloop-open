...
/** "Sep 9" style short date, no time, no year -- used where a caption has to fit under something
 * narrow (an earned patch's medal, portfolio sash): formatDateTime's "September 9 at 9:00 AM"
