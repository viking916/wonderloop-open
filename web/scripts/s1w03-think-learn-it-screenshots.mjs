...
const TARGETS = [["v2-fraction-idea", stepIndex("s1-w03-think-07")],["v2-fraction-examples", stepIndex("s1-w03-think-10")],["v2-find-rule", stepIndex("s1-w03-think-09")]];
...
async function shoot(page, label, viewport) {
  const file = path.join(SCREENSHOT_DIR, `s1w03-think-${label}-${viewport.name}.png`);
