 ...
 */
export function WeekHeader({ seasonId, currentWeek, displayedWeek, trailWeeks, onPickWeek }: WeekHeaderProps) {
    ...
    <>
          ...
          return (
            <div className={classes} key={season.id}>
              ...
              <span className="tr-season__label">
                <span className="tr-season__name">
                  Season {season.id} · {season.name}
                </span>
                <span className="tr-season__state">{on ? `wk ${currentWeek}` : "locked"}</span>
              </span>
            </div>
          );
        })}
      ...
      <div className="tr-map">
        ...
        <div className="tr-week-picker">
          <label htmlFor="tr-week-select" className="tr-meta">Jump to a different week</label>
          ...
          {isJump ? (
            <span className="tr-week-picker__jump tr-meta">
      ...
      {isShowcase ? (
        <div className="tr-showcase-banner">
          ...
          <span>Every track feeds the same demo this week.</span>
        </div>
      ) : null}
    </>
  );
