            ...
            <div className="tr-step__actions">
              {done ? (
                <>
                  ...
                  <Button variant="quiet" onClick={() => setDone(extra.id, false)} pending={saving === extra.id} pendingLabel="Working">
                    Undo
                  </Button>
                </>
              ) : (
                <Button variant="secondary" onClick={() => setDone(extra.id, true)} pending={saving === extra.id} pendingLabel="Saving">
                  I did this
                </Button>
              )}
            </div>
