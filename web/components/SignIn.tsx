...
export function SignIn() {
  ...
  // Returns its own Promise (never rethrows) so Button.tsx's automatic tracking can watch it
  // directly -- owner report: "Many times when I press button nothing happens instantly so it
  // makes me feel like something is broken", and this is the very first tap a family ever makes.
  ...
  return (
    <div className="tr-signin">
      <Card tone="surface" shadow className="tr-signin__card">
        ...
        <Button variant="primary" onClick={handleSignIn} pendingLabel="Signing in">
          Sign in with Google
        </Button>
