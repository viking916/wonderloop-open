...
import { PracticeCard } from "@/components/parent/PracticeCard";
...
function ParentHome({ profile, householdId, profiles }: { profile: Profile; householdId: string; profiles: Profile[] }) {
  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <main className="tr-page pr-page">
    ...
    <section className="pr-child" aria-label={`${profile.name}'s progress`} hidden={!isSelected}>
      {isSelected && activeTab === "week" ? (
        <>
          ...
          <PracticeCard householdId={householdId} profileId={profile.id} seasonId={profile.seasonId} currentWeek={currentWeek} choice={profile} />
